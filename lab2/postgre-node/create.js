...
/*pool.query("CREATE TABLE users1(id SERIAL PRIMARY KEY, name VARCHAR(40) NOT NULL,telephone_number VARCHAR(40) NOT NULL)", (err, res) => {
console.log(err, res);
pool.end();
});*/
...
pool.query("ALTER TABLE users1 ADD COLUMN id_order int", (err, res) => {
console.log(err, res);
pool.end();
});